...
- Function return: try to return a more general class instead of a more concrete one. - why? [TODO]
    - [StackOverflow Discussio n](https://stackoverflow.com/questions/37971533/is-it-possible-to-return-a-hashmap-object-in-java)
...
- Sorting Complexity Analysis [TODO]
    ...
    - Apace complexity: O(1), there's a way that no extra space needs to be used (change content inside the original container)
